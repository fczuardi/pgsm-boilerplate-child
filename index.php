...
if ($author_id) {
  ...
  if( have_posts() ) : 
          ...
          <p class="time-and-author colapse-toggle"><time pubdate  class="colapse-toggle" datetime="<?php the_date('c');?>"><?php the_time('D j M Y : h\hi'); ?></time> : <span class="publicado-por colapse-toggle"><?php echo _e('Publicado por', 'pgsm-boilerplate-child'); ?> <?php the_author() ?></span></p>
